 ...
 */
final class Version20241120225012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE accessoire (id INT AUTO_INCREMENT NOT NULL, accessoire_id INT NOT NULL, nom VARCHAR(255) NOT NULL, prix INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE admin (id INT AUTO_INCREMENT NOT NULL, admin_id INT NOT NULL, username VARCHAR(50) NOT NULL, password VARCHAR(255) NOT NULL, role VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE coque (id INT AUTO_INCREMENT NOT NULL, coque_id INT NOT NULL, type VARCHAR(255) NOT NULL, prix INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE coque_couleur (coque_id INT NOT NULL, couleur_id INT NOT NULL, INDEX IDX_F2D4BD9E220CEEF5 (coque_id), INDEX IDX_F2D4BD9EC31BA576 (couleur_id), PRIMARY KEY(coque_id, couleur_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE couleur (id INT AUTO_INCREMENT NOT NULL, couleur_id INT NOT NULL, nom VARCHAR(255) NOT NULL, code_hex VARCHAR(8) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, produit_id_id INT DEFAULT NULL, couleur_id_id INT NOT NULL, image_id INT NOT NULL, type_element VARCHAR(255) NOT NULL, vue VARCHAR(255) NOT NULL, url_image VARCHAR(255) NOT NULL, image_file VARCHAR(255) NOT NULL, INDEX IDX_C53D045F4FD8F9C3 (produit_id_id), INDEX IDX_C53D045F6F285051 (couleur_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, produit_id INT NOT NULL, nom VARCHAR(255) NOT NULL, prix_base INT NOT NULL, description LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE produit_configuration (id INT AUTO_INCREMENT NOT NULL, produit_id_id INT NOT NULL, coque_avant_id_id INT NOT NULL, coque_arriere_id_id INT DEFAULT NULL, ecran_ips_id_id INT DEFAULT NULL, button_id_id INT DEFAULT NULL, pad_id_id INT DEFAULT NULL, configuration_id INT NOT NULL, installation_batterie TINYINT(1) NOT NULL, accn TINYINT(1) NOT NULL, INDEX IDX_8BBC03094FD8F9C3 (produit_id_id), INDEX IDX_8BBC03096A8EDBCF (coque_avant_id_id), INDEX IDX_8BBC0309B0746CEA (coque_arriere_id_id), INDEX IDX_8BBC0309B09A649F (ecran_ips_id_id), INDEX IDX_8BBC0309F4D82BB5 (button_id_id), INDEX IDX_8BBC030931ACCCC0 (pad_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
